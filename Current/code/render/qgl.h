...
extern GLvoid			(APIENTRY * qglVertexAttribPointerARB)(GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const GLvoid *pointer);
...
extern GLvoid			(APIENTRY * qglProgramEnvParameter4fvARB)(GLenum target, GLuint index, const GLfloat *params);
extern GLvoid			(APIENTRY * qglProgramLocalParameter4fARB)(GLenum target, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
extern GLvoid			(APIENTRY * qglProgramLocalParameter4fvARB)(GLenum target, GLuint index, const GLfloat *params);
extern GLvoid			(APIENTRY * qglGetProgramivARB)(GLenum target, GLenum pname, GLint *params);
...
extern GLvoid			(APIENTRY * qglCombinerParameterfvNV)(GLenum pname, const GLfloat *params);
extern GLvoid			(APIENTRY * qglCombinerParameterfNV)(GLenum pname, GLfloat param);
extern GLvoid			(APIENTRY * qglCombinerParameterivNV)(GLenum pname, const GLint *params);
extern GLvoid			(APIENTRY * qglCombinerParameteriNV)(GLenum pname, GLint param);
extern GLvoid			(APIENTRY * qglCombinerInputNV)(GLenum stage, GLenum portion, GLenum variable, GLenum input, GLenum mapping, GLenum componentUsage);
extern GLvoid			(APIENTRY * qglCombinerOutputNV)(GLenum stage, GLenum portion, GLenum abOutput, GLenum cdOutput, GLenum sumOutput, GLenum scale, GLenum bias, GLboolean abDotProduct, GLboolean cdDotProduct, GLboolean muxSum);
extern GLvoid			(APIENTRY * qglFinalCombinerInputNV)(GLenum variable, GLenum input, GLenum mapping, GLenum componentUsage);

extern GLuint			(APIENTRY * qglGenFragmentShadersATI)(GLuint range);
extern GLvoid			(APIENTRY * qglBindFragmentShaderATI)(GLuint id);
extern GLvoid			(APIENTRY * qglDeleteFragmentShaderATI)(GLuint id);
extern GLvoid			(APIENTRY * qglBeginFragmentShaderATI)(GLvoid);
extern GLvoid			(APIENTRY * qglEndFragmentShaderATI)(GLvoid);
extern GLvoid			(APIENTRY * qglPassTexCoordATI)(GLuint dst, GLuint coord, GLenum swizzle);
extern GLvoid			(APIENTRY * qglSampleMapATI)(GLuint dst, GLuint interp, GLenum swizzle);
extern GLvoid			(APIENTRY * qglColorFragmentOp1ATI)(GLenum op, GLuint dst, GLuint dstMask, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod);
extern GLvoid			(APIENTRY * qglColorFragmentOp2ATI)(GLenum op, GLuint dst, GLuint dstMask, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod, GLuint arg2, GLuint arg2Rep, GLuint arg2Mod);
extern GLvoid			(APIENTRY * qglColorFragmentOp3ATI)(GLenum op, GLuint dst, GLuint dstMask, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod, GLuint arg2, GLuint arg2Rep, GLuint arg2Mod, GLuint arg3, GLuint arg3Rep, GLuint arg3Mod);
extern GLvoid			(APIENTRY * qglAlphaFragmentOp1ATI)(GLenum op, GLuint dst, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod);
extern GLvoid			(APIENTRY * qglAlphaFragmentOp2ATI)(GLenum op, GLuint dst, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod, GLuint arg2, GLuint arg2Rep, GLuint arg2Mod);
extern GLvoid			(APIENTRY * qglAlphaFragmentOp3ATI)(GLenum op, GLuint dst, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod, GLuint arg2, GLuint arg2Rep, GLuint arg2Mod, GLuint arg3, GLuint arg3Rep, GLuint arg3Mod);
extern GLvoid			(APIENTRY * qglSetFragmentShaderConstantATI)(GLuint dst, const GLfloat *value);
